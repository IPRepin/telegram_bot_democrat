"""Модуль для борьбы с флудом Middleware
предотвращает многократное нажатие кнопок в боте в течении
...
class ThrottlingMiddleware(BaseMiddleware):
    ...
    async def target_throttled(
        ...
        msg = target.message if isinstance(target,
                                           types.CallbackQuery) else target
